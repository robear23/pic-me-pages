      ...
      <div className="max-w-5xl w-full">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground text-center mb-8">
            Adjust settings for pages: {selectedPagesForRework.sort((a, b) => a - b).join(', ')}
          </p>
          ...
          {originalGenerationParams && (
            <Alert className="mb-8 border-primary/30 bg-primary/5">
              <AlertDescription>
                <strong>Original settings:</strong> {originalGenerationParams.complexity} complexity, {originalGenerationParams.artStyle} style
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Keep characters looking the same across pages
                </p>
              </div>
              <Switch
          ...
          >
            ...
            Generate Reworks ({selectedPagesForRework.length} page{selectedPagesForRework.length !== 1 ? 's' : ''})
          </Button>
        </motion.div>
      </div>
    </motion.div>
