...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // This endpoint requires admin access to prevent unauthorized job triggering
    ...
    // Step 1: Check daily spend limit (supabase already defined above with service role)
